...
library ChainlinkVRF {
     ...
     */
    VRFCoordinatorV2Interface private constant _VRF_COORDINATOR = VRFCoordinatorV2Interface(0x8103B0A8A00be2DDC778e6e7eaa21791Cd364625);
    ...
    function request(uint32 numWord_) internal returns (uint256 requestId) {
        requestId = _VRF_COORDINATOR.requestRandomWords(_VRF_KEY_HASH, _SUBSCRIPTION_ID, _VRF_REQUEST_CONFIRMATION, _CALLBACK_GAS_LIMIT, numWord_);
    }
}
